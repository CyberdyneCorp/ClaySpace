...
/// Move Topological — all shipping.
/// (Relax joins them with the Smooth brush, on its own branch.)
///
/// All three were found to tear the surface over detailed geometry, leaving
/// a box-shaped crater with hard edges and holes through the object. The
/// brush fixtures could never have caught it: every one of them acts on a
/// plain seeded ball, where the sampled region contains a single smooth
/// surface and the seam is benign.
///
